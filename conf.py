...
BLOG_AUTHOR = "CoLoMoTo Consortium" # (translatable)
...
TAG_PATH = INDEX_PATH+"/categories"
...
# (translatable)
CONTENT_FOOTER = '&copy; {date}  {author}  (<a href="mailto:{email}">{email}</a>) - Powered by  <a href="http://getnikola.com" rel="nofollow">Nikola</a>'
...
ga('create', 'UA-55638304-1', 'auto');
ga('send', 'pageview');
</script>"""
if not is_devel:
    BODY_END = GOOGLE_ANALYTICS
